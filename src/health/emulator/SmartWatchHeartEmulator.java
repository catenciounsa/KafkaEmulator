...
/**
 * This is the graphic emulator of a smartwatch monitoring the beeps per minute
 * 
 * @author Carlos Torres
 * @email catencio@unsa.edu.pe
 *
 */
public class SmartWatchHeartEmulator extends JFrame {
	...
	private PersonSmartwatchHeart monitoredPerson;

	public SmartWatchHeartEmulator() {
		setTitle("SmartWatch");
	...
	class DrawSmartWatch extends JPanel {
		...
		public void paintComponent( Graphics g ) {
			g.setColor(Color.DARK_GRAY); g.fillRect(50,0,40,60);
			
			try {
				BufferedImage image = ImageIO.read( new File("etc/smartwatch.png") );
				
				int w = image.getWidth(), h = image.getHeight();
				
				g.drawImage( image, 0,0, 400, 250, 0, 0, w, h, null );
			...
			g2d.rotate(-0.2);
			g2d.setColor(Color.darkGray); g2d.fillOval(125, 109, 100, 100);
			g2d.setColor(Color.white); g2d.fillRect(135, 140, 80, 20);
			g2d.setFont(new Font("Arial", Font.PLAIN, 15));
			String str_bpm = monitoredPerson.getBpm()+" bpm";
			g2d.setColor(Color.RED); g2d.drawString(str_bpm, 140, 155);
